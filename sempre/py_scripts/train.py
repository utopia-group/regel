...
def _parse_args():
    ...
    args.grammar = "turk" if "turk" in args.dataset else "regex"
    return args

def train(args):
    cmd = "sh ./py_scripts/train.sh {0} {1} {2} {3} {4}".format(args.dataset, '"' + args.model + '"', args.beam, args.max_iter, args.grammar)
    print(cmd)
    os.system(cmd)
